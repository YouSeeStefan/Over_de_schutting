...
<section id="user-panel">
    <div  class="user">
        <a href="./klompies/index.html"><span class="tooltip" title="Account login"></span></a>
    </div>
    <div class="edit">
       <a href="./CMS/admin/list.php"><span class="tooltip" title="Pagina bewerken"></span></a>
    </div>
    <div class="calender">
        <a href="./Events/admin/add.php"><span class="tooltip" title="Evenement toevoegen"></span></a>
    </div>
    <div class="log-out">
        <a href="klompies/logout.php"><span class="tooltip" title="Uitloggen"></span></a>
    </div>
</section>
